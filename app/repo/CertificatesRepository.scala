...
/**
  ...
  */
class CertificatesRepository @Inject()(protected val dbConfigProvider: DatabaseConfigProvider) extends HasDatabaseConfigProvider[JdbcProfile] {

    import driver.api._
    private val certificateTable = TableQuery[CertificateTable]

    private class CertificateTable(tag:Tag) extends Table[Certificates](tag,"certificate") {

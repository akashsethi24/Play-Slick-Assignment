...
class CertificateServices @Inject()(certRepo: CertificatesRepository)
    extends CertificateServiceApi {
  ...
  override def createCertificateTable(): Boolean = {
    certRepo.createCertificateTable()
  }

  override def getById(id: Int): Future[Option[Certificates]] = {
    certRepo.getById(id)
  }
}
